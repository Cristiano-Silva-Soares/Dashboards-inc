...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("Project - Dashboards.inc").description("Project for logging and creating users in a site - Dashboards.inc")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("http://localhost:8080/swagger-ui/")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Cristiano da Silva Soares", "https://github.com/Cristiano-Silva-Soares", "criztianosoares99@outlook.com");
	}
